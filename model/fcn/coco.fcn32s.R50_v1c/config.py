...
C.data_root_path = "/home/duy/phd/lucasdu/duy/coco_train2017_refine_training/info.txt"
C.is_test = False
...
C.bn_momentum = 0.1
C.loss_weight = None
C.pretrained_model = "/home/duy/.cache/torch/checkpoints/resnet101-5d3b4d8f.pth"
