...
class FCN(nn.Module):
    def __init__(self, out_planes, criterion, inplace=True,
        ...
        self.backbone = resnet18(pretrained_model, inplace=inplace,
        ...
        self.business_layer = []
        self.head = _FCNHead(512, out_planes, inplace, norm_layer=norm_layer)
        self.aux_head = _FCNHead(256, out_planes, inplace,
                                 norm_layer=norm_layer)
