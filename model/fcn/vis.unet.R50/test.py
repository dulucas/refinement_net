...
def eval(model, name, use_gt=False):
    video_name = '45a89f35e1' #config.data_root_path.split('/')[-2] #'8939db6354'
    ...
    for image_name in images_name:
        ...
        if use_gt:
            ...
            gt = Image.open(image_name.replace('train_all_frames/JPEGImages', 'semseg_vis/train').replace('jpg', 'png'))
